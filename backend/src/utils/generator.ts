...
import { generateAdditionSubtractionTask } from '../generators/addition.js';
import { generateDivisionTask } from '../generators/division.js';
import { generateMultiplicationTask } from '../generators/multiplication.js';
import type { Config, Task } from '../types.js';
import { calculateAnswer, shuffleInPlace } from './math.js';
...
export function generateDateSeed(): string {
    const now = new Date();
